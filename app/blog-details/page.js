                ...
                <div className="blog-details__left">
                  ...
                  <div className="blog-details__content">
                    ...
                    <p className="blog-details__text-1">
                      ...
                      of any website is the first impression on visitors.Web
                    ...
                    <div className="blog-details__author-box">
                      <p className="blog-details__author-text">
                        ...
                        matti ullamcorper posuere vive rra .Aliquam eros justo,
                        posuere lobortis, viverra laoreet augue mattis fermentu
                        m ul amcorper viverra laoreet.
                      </p>
                      <span className="blog-details__author-name">
                        Mark wood
                      </span>
                    ...
                    <div className="comment-one__single">
                      ...
                      <div className="comment-one__content">
                        ...
                        <p>
                          ...
                          acted Aliquam eros justo. Ished fact that a reader
                          will be distrol acted bioii the.i
                        </p>
                  ...
                  <div className="comment-form">
                    ...
                    <form className="comment-form__form contact-form-validated">
                      <div className="row">
                        ...
                        <div className="col-xl-12">
                          ...
                          <div className="comment-form__check-and-btn">
                            <div className="checked-box">
                              ...
                              />
                              <label>
                                <span></span>Save my name email and website
                              </label>
                            </div>
                    ...
                    <ul className="sidebar__post-list list-unstyled">
                      <li>
                        ...
                        <div className="sidebar__post-content">
                          <p className="sidebar__post-date">
                            <span className="icon-calender"></span>October 19,
                            2022
                          </p>
                          <h3 className="sidebar__post-title">
                            <Link href="blog-details">
                              Funding Research for a Cure Charity
                            </Link>
                          </h3>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="sidebar__post-content">
                          ...
                          <h3 className="sidebar__post-title">
                            <Link href="blog-details">
                              Supporting Mental Health Initiatives Donations
                            </Link>
                          </h3>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="sidebar__post-content">
                          ...
                          <h3 className="sidebar__post-title">
                            <Link href="blog-details">
                              Caring for the Elderly and Vulnerable at a Time
                            </Link>
                          </h3>
                        </div>
                      </li>
