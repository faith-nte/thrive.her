            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-7">
                <div className="become-volinteer__right">
                  ...
                  <p className="become-volinteer__text-1">
                  ...
                  <p className="become-volinteer__text-3">
                    When you work with us, you deal directly with the marketing
                    superstars who are capable of both providing strategic
                    advice and executing the plan. It’s a model we’re really
                    proud of and produces amazing results.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-6">
                  <div className="become-volinteer__bottom-title-box">
                    <h2 className="become-volinteer__bottom-left-title">
                      Fill Form and Beacame Volonteer
                    </h2>
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6">
                  <p className="become-volinteer__bottom-text">
                    who are capable of both providing strategic advice and
                    executing the plan. It’s a model we’re really proud of and
