  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={2} breadcrumbTitle="Resources">
        {/* Resources Section */}
        <section className="py-24 sm:py-32 lg:py-40" style={{ backgroundColor: '#F9E8CF' }}>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center mb-12">
              ...
              <p
                ...
                style={{ color: '#21273F' }}
              >
                Download training materials, clinical guidelines, and community resources to support culturally competent care.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {resources.map((resource) => (
                <div
                  ...
                  style={{ backgroundColor: '#ffffff', border: '1px solid #D1A38A' }}
                >
            ...
            <div
              ...
              style={{ backgroundColor: '#E8F3F3', border: '2px dashed #3A7C7C' }}
            >
              <h3 className="text-lg font-semibold mb-2" style={{ color: '#21273F' }}>
                📁 Upload Resources (CMS-Ready)
              </h3>
              <p style={{ color: '#21273F' }}>
                This section can be connected to a CMS for staff and admins to upload new resources, manage categories, and track downloads.
              </p>
            </div>
          </div>
        </section>
