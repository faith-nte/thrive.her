            ...
            <div className="events-list__inner">
              ...
              <div className="events-list__single-and-date">
                <div className="events-list__single">
                  ...
                  <div className="events-list__content">
                    <h3 className="events-list__title">
                      <Link href="event-details">Donation Drive</Link>
                    </h3>
                    <p className="events-list__text">
                      Lorem Ipsum is simply dummy a of the printing and type
                      setting industry Loreaim Ipsum has Southern grayling
                      trout-perch. printing and type setting industry Loreaim
                      Ipsum has
                    </p>
                    <ul className="events-list__date list-unstyled">
                      <li>
                        ...
                        <p>
                          <span>September 30,</span> 10:00 AM -{" "}
                          <span>October 31,</span> 18:00 PM
                        </p>
                      </li>
                      <li>
                        <div className="icon">
              ...
              <div className="events-list__single-and-date">
                <div className="events-list__single">
                  ...
                  <div className="events-list__content">
                    <h3 className="events-list__title">
                      <Link href="event-details">Help For Ecosystem</Link>
                    </h3>
                    <p className="events-list__text">
                      Lorem Ipsum is simply dummy a of the printing and type
                      setting industry Loreaim Ipsum has Southern grayling
              ...
              <div className="events-list__single-and-date">
                <div className="events-list__single">
                  ...
                  <div className="events-list__content">
                    <h3 className="events-list__title">
                      <Link href="event-details">Water For All</Link>
                    </h3>
                    <p className="events-list__text">
                      Lorem Ipsum is simply dummy a of the printing and type
                      setting industry Loreaim Ipsum has Southern grayling
              ...
              <div className="events-list__single-and-date">
                <div className="events-list__single">
                  ...
                  <div className="events-list__content">
                    <h3 className="events-list__title">
                      <Link href="event-details">Vaccine Aid Camp</Link>
                    </h3>
                    <p className="events-list__text">
                      Lorem Ipsum is simply dummy a of the printing and type
                      setting industry Loreaim Ipsum has Southern grayling
