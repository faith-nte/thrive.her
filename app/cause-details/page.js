...
export default function Home() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Cause details">
        {/*Cause Details Start*/}
              ...
              <div className="col-xl-8 col-lg-7">
                <div className="cause-details__left">
                  ...
                  <div className="cause-details__meta list-unstyled">
                    <Link href="#">
                      <span className="fas fa-heart"></span>water
                    </Link>
                  </div>
                  <h2 className="cause-details__title">
                    African People Need Pure Water
                  </h2>
                  <div className="cause-details__progress-box">
                    ...
                    <div className="cause-details__goals">
                      <div className="cause-details__raised">
                        <p>
                          <i className="fal fa-donate"></i>70%{" "}
                          <span>Raised</span>
                        </p>
                      </div>
                      <div className="cause-details__raised">
                        <p>
                          <i className="far fa-analytics"></i> 100,000$
                          <span>Goal</span>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="cause-details__donate-and-btn">
                    ...
                    <div className="cause-details__donate-box">
                      ...
                      <div className="cause-details__donate-btn">
                        <button type="submit">
                          <span className="fas fa-heart"></span>Donate Now
                        </button>
                      </div>
                    </div>
                  </div>
                  <p className="cause-details__text-1">
                    ...
                    website is the first impression on visitors.Web designing in
                    a powerful way of just not an only professions, however, in
                    a passion for our Company. We have
                  </p>
                  <p className="cause-details__text-2">
                    ut many people around the world don’t have that luxury.
                  ...
                  <p className="cause-details__text-3">
                    ...
                    website is the first impression on visitors.Web designing in
                    a powerful way of just not an only professions, however, in
                    a passion for our Company.We have to a tendency to believe
                    the idea that smart looking of any website is the first
                  ...
                  <p className="cause-details__text-4">
                    ...
                    in the <span className="color-black">19th century.</span> If
                    you can only give <span className="color-base">£10</span>{" "}
                  ...
                  <p className="cause-details__text-5">
                    ...
                    protections and BioSand filters that help provide clean
                    water to communities around the world.ut many people around
                    ...
                    simple solutions like drilled wells, spring protections and
                    BioSand filters
                  </p>
                    ...
                    <ul className="sidebar__category-list list-unstyled">
                      <li>
                        <Link href="blog-details">
                          Donation Drive<span>59</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                          Community Outreach<span>35</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                          Volunteer Assistance<span>12</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                          Fundraising Event<span>46</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                          Support Network<span>78</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                          Philanthropic Initiative<span>89</span>
                        </Link>
                      </li>
                    </ul>
                  </div>
