...
export default function Home() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Events Carousel">
                  ...
                  <div className="event-one__single">
                    ...
                    <div className="event-one__content">
                      <h4 className="event-one__title">
                        <Link href="cause-details">Donation Drive</Link>
                      </h4>
              ...
              <SwiperSlide>
                ...
                <div className="item">
                  <div className="event-one__single">
                    ...
                    <div className="event-one__content">
                      <h4 className="event-one__title">
                        <Link href="cause-details">win-win survival</Link>
                      </h4>
                      <p className="event-one__text">
                        Lorem Ipsum is simply dummy a of the printing and type
                        setting industry Loreaim Ipsum has
              ...
              <SwiperSlide>
                ...
                <div className="item">
                  <div className="event-one__single">
                    ...
                    <div className="event-one__content">
                      <h4 className="event-one__title">
                        <Link href="cause-details">Children Education.</Link>
                      </h4>
                      <p className="event-one__text">
                        Lorem Ipsum is simply dummy a of the printing and type
                        setting industry Loreaim Ipsum has
