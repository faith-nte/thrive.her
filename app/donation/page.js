...
export default function Home() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Donation">
        {/*Donation Page Start*/}
            ...
            <div className="row">
              ...
              >
                <div className="donate-three__single donate-three__single-3">
                  ...
                  <div className="donate-three__content">
                    <h3 className="donate-three__title">
                      <Link href="donation-details">Medicine For Africans</Link>
                    </h3>
                    <p className="donate-three__text">
                      Dicta sunt explicabo. Nemo enim ipsam voluptatem quia
                      voluptas sit asuraut
              ...
              >
                <div className="donate-three__single donate-three__single-1">
                  ...
                  <div className="donate-three__content">
                    <h3 className="donate-three__title">
                      <Link href="donation-details">Poverty Help Fund</Link>
                    </h3>
                    <p className="donate-three__text">
                      Dicta sunt explicabo. Nemo enim ipsam voluptatem quia
                      voluptas sit asuraut
              ...
              >
                <div className="donate-three__single donate-three__single-3">
                  ...
                  <div className="donate-three__content">
                    <h3 className="donate-three__title">
                      <Link href="donation-details">Africans Ecosystem</Link>
                    </h3>
                    <p className="donate-three__text">
                      Dicta sunt explicabo. Nemo enim ipsam voluptatem quia
                      voluptas sit asuraut
