                    ...
                    <div className="col-xl-6">
                        <div className="about-three__right">
                            <div className="section-title text-left sec-title-animation animation-style2">
                                ...
                                <h2 className="section-title__title title-animation" style={{ color: '#21273F' }}>Together We Can Make
                                    <br/>a Difference</h2>
                            </div>
                            <p className="about-three__text" style={{ color: '#21273F' }}>Lorem Ipsum is simply dummy a of the printing and type setting
                                industry Loreaim Ipsum has been the industry's standard dummy</p>
                            <ul className="about-three__points list-unstyled">
                                <li>
                                    <div className="icon">
                                        <span className="icon-check" style={{ color: '#C78E1D' }}></span>
                                    </div>
                                    <p style={{ color: '#21273F' }}>Uniting Hearts, Healing Communities</p>
                                </li>
                                <li>
                                    <div className="icon">
                                        <span className="icon-check" style={{ color: '#C78E1D' }}></span>
                            ...
                            <div className="about-three__btn-and-need-help">
                                ...
                                <div className="about-three__need-help">
                                    <div className="about-three__need-help-icon">
                                        <span className="icon-phone-call" style={{ color: '#C78E1D' }}></span>
                                    </div>
                                    <div className="content">
                                        <span style={{ color: '#21273F', fontWeight: '600' }}>Need help?</span>
                                        <p><Link href="tel:3195550115" style={{ color: '#21273F', textDecoration: 'none' }}>(319) 555-0115</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
