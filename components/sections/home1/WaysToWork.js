  ...
  const cards = [
    {
      ...
      icon: '👥',
      details: ['Train local advocates', 'Peer-to-peer support', 'Community events'],
    },
    {
      id: 2,
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: '#D1A38A' }}>
            Ways to Partner
          </p>
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4" style={{ color: '#21273F' }}>
            Ways to Work With Us
          </h2>
          <p className="text-lg leading-8" style={{ color: '#21273F' }}>
            Choose the partnership model that best fits your organisational goals and capacity.
          </p>
        </div>
        ...
        >
          {cards.map((card) => (
            ...
            >
              ...
              {/* Description */}
              <div className="p-8">
                <p className="text-base leading-relaxed mb-6">{card.description}</p>
