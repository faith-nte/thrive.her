                ...
                <div className="product__sidebar">
                  ...
                  <div className="shop-category product__sidebar-single">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="active">
                        <Link href="#">Make World Happier</Link>
                      </li>
                      <li>
                        <Link href="#">Education For People</Link>
                      </li>
                      <li>
                        <Link href="#">Food & Build Home</Link>
                      </li>
                      <li>
                        <Link href="#">Environtment Recyle</Link>
                      </li>
                    </ul>
                  </div>
                        ...
                        <div className="product__all-single">
                          ...
                          <div className="product__all-content">
                            ...
                            <h4 className="product__all-title">
                              <Link href="product-details">Classy chair</Link>
                            </h4>
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="product__all-single">
                          ...
                          <div className="product__all-content">
                            ...
                            <h4 className="product__all-title">
                              <Link href="product-details">Comfy chair</Link>
                            </h4>
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="product__all-single">
                          ...
                          <div className="product__all-content">
                            ...
                            <h4 className="product__all-title">
                              <Link href="product-details">Boss chair</Link>
                            </h4>
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="product__all-single">
                          ...
                          <div className="product__all-content">
                            ...
                            <h4 className="product__all-title">
                              <Link href="product-details">Classic chair</Link>
                            </h4>
                            <p className="product__all-price">$33.00</p>
                            <div className="product__all-btn-box">
                              <Link
