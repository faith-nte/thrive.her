              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <p className="testimonial-one__text">
                    Listened carefully to Lisa's needs and translated them into
                    a stunning is a website. The design is modern and to
                    calming, with beautiful imagery that captures the essence of
                    Blooming
                  </p>
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Darlene Robertson</Link>
                      </h3>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Floyd Miles</Link>
                      </h3>
                      <p className="testimonial-one__client-sub-title">
                        Medical Assistant
                      </p>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Leslie Alexander</Link>
                      </h3>
                      <p className="testimonial-one__client-sub-title">
                        Web Designer
                      </p>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Cameron Williamson</Link>
                      </h3>
                      <p className="testimonial-one__client-sub-title">
                        Medical Assistant
                      </p>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Andre Robertson</Link>
                      </h3>
                      <p className="testimonial-one__client-sub-title">
                        Web Designer
                      </p>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="testimonial-one__single">
                  ...
                  <div className="testimonial-one__client-info">
                    ...
                    <div className="testimonial-one__client-content">
                      <h3 className="testimonial-one__client-name">
                        <Link href="testimonials">Floyd Jack</Link>
                      </h3>
                      <p className="testimonial-one__client-sub-title">
                        Medical Assistant
                      </p>
